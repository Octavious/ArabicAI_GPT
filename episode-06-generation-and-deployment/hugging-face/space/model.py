...
class GPT(nn.Module):
    ...
    def generate(self, idx, max_new_tokens, temperature=1.0, top_k=None, eos_token_id=None):
        ...
        Args:
            ...
            eos_token_id:   if set, stop when this token is sampled (e.g. <|endoftext|>)
        ...
        for _ in range(max_new_tokens):
            ...
            # Keep EOS in the candidate set when early stopping is enabled.
            if top_k is not None:
                ...
                if eos_token_id is not None:
                    logits[:, eos_token_id] = eos_logits
